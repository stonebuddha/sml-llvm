...
fun write_bitcode_to_fd (U : bool option) (M : llmodule) (FD : Posix.FileSys.file_desc) : bool =
...
fun output_bitcode (U : bool option) (S : BinIO.outstream) (M : llmodule) : bool =
